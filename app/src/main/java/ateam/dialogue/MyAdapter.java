...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, int ViewType, Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if (ViewType == TYPE_ITEM) {
                ...
                idHolder = 1;                                               // setting holder id as 1 as the object being populated are of type item row
            } else {
                ...
                idHolder = 0;                                                // Setting holder id = 0 as the object being populated are of type header view
            }
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if (holder.idHolder == 1) {                              // as the list view is going to be called after the header view so we decrement the
